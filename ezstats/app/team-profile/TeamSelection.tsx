...
export default function TeamSelector({
  ...
  return (
    <div className="col-span-6 md:col-span-2 bg-white rounded-xl border border-border p-5 flex flex-col gap-3">
      ...
      {showAddTeam ? (
        <div className="flex flex-col gap-2 border border-dashed border-primary rounded-lg p-3 bg-primary-bg/40">
          <input
